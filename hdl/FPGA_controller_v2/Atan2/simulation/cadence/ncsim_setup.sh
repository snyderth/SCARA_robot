...
# ACDS 19.1 670 linux 2020.02.22.22:07:17
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/thomas/intelFPGA_lite/19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Atan2_CORDIC_0.vhd"        -work CORDIC_0 -cdslib ./cds_libs/CORDIC_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/Atan2.v"                                                                                
fi

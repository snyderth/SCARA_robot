...
//altfp_div CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" OPTIMIZE="AREA" PIPELINE=10 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab division_by_zero nan overflow result underflow zero
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  DoubleDiv_altfp_div_c5m
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	assign
		...
		underflow = wire_altfp_div_pst1_underflow,
		zero = wire_altfp_div_pst1_zero;
endmodule //DoubleDiv_altfp_div_c5m
//VALID FILE
...
module DoubleDiv (
	...
	DoubleDiv_altfp_div_c5m	DoubleDiv_altfp_div_c5m_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),

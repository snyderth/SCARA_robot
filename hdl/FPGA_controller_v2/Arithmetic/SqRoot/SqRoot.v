...
//altfp_sqrt CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=30 ROUNDING="TO_NEAREST" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock data result
...
//alt_sqrt_block CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=30 WIDTH_SQRT=54 aclr clken clock rad root_result
//VERSION_BEGIN 18.1 cbx_altfp_sqrt 2018:09:12:13:04:24:SJ cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ  VERSION_END
...
module  SqRoot_alt_sqrt_block_mcb
	( 
	aclr,
	clken,
	clock,
...
endmodule //SqRoot_alt_sqrt_block_mcb

//synthesis_resources = lpm_add_sub 56 reg 2983 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  SqRoot_altfp_sqrt_l8d
	( 
	clk_en,
	clock,
	data,
...
`endif
	...
	SqRoot_alt_sqrt_block_mcb   alt_sqrt_block2
	( 
	.aclr(aclr),
	.clken(clk_en),
	.clock(clock),
...
endmodule //SqRoot_altfp_sqrt_l8d
//VALID FILE
...
module SqRoot (
	...
	SqRoot_altfp_sqrt_l8d	SqRoot_altfp_sqrt_l8d_component (
				.clk_en (clk_en),
				.clock (clock),
				.data (data),
				.result (sub_wire0));

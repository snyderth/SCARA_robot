...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="AREA" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=11 WIDTH_MAN=52 clk_en clock dataa datab overflow result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" WIDTH=55 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  Adder_altbarrel_shift_ptd
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Adder_altbarrel_shift_ptd
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altbarrel_shift_u0g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	assign
		...
		sel_w = {sel_pipec5r1d, sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({55{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[297:275], pad_w[31:0]}) | ({55{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[329:307]})) | ({55{(~ sel_w[5])}} & sbit_w[329:275])), ((({55{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[258:220], pad_w[15:0]}) | ({55{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[274:236]})) | ({55{(~ sel_w[4])}} & sbit_w[274:220])), ((({55{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[211:165], pad_w[7:0]}) | ({55{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[219:173]})) | ({55{(~ sel_w[3])}} & sbit_w[219:165])), ((({55{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[160:110], pad_w[3:0]}) | ({55{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[164:114]})) | ({55{(~ sel_w[2])}} & sbit_w[164:110])), ((({55{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[107:55], pad_w[1:0]}) | ({55{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[109:57]})) | ({55{(~ sel_w[1])}} & sbit_w[109:55])), ((({55{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[53:0], pad_w[0]}) | ({55{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[54:1]})) | ({55{(~ sel_w[0])}} & sbit_w[54:0]))};
endmodule //Adder_altbarrel_shift_u0g
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //Adder_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //Adder_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	Adder_altpriority_encoder_3v7   altpriority_encoder18
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder18_q));
	Adder_altpriority_encoder_3e8   altpriority_encoder19
	( 
	.data(data[3:2]),
...
endmodule //Adder_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_3e8   altpriority_encoder20
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder20_q),
	.zero(wire_altpriority_encoder20_zero));
	Adder_altpriority_encoder_3e8   altpriority_encoder21
	( 
	.data(data[3:2]),
...
endmodule //Adder_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	Adder_altpriority_encoder_6v7   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q));
	Adder_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //Adder_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_6e8   altpriority_encoder22
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder22_q),
	.zero(wire_altpriority_encoder22_zero));
	Adder_altpriority_encoder_6e8   altpriority_encoder23
	( 
	.data(data[7:4]),
...
endmodule //Adder_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	Adder_altpriority_encoder_bv7   altpriority_encoder14
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder14_q));
	Adder_altpriority_encoder_be8   altpriority_encoder15
	( 
	.data(data[15:8]),
...
endmodule //Adder_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_be8   altpriority_encoder24
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder24_q),
	.zero(wire_altpriority_encoder24_zero));
	Adder_altpriority_encoder_be8   altpriority_encoder25
	( 
	.data(data[15:8]),
...
endmodule //Adder_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_tv8
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	Adder_altpriority_encoder_r08   altpriority_encoder12
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder12_q));
	Adder_altpriority_encoder_rf8   altpriority_encoder13
	( 
	.data(data[31:16]),
...
endmodule //Adder_altpriority_encoder_tv8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_te9
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_rf8   altpriority_encoder26
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder26_q),
	.zero(wire_altpriority_encoder26_zero));
	Adder_altpriority_encoder_rf8   altpriority_encoder27
	( 
	.data(data[31:16]),
...
endmodule //Adder_altpriority_encoder_te9

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_uu8
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	Adder_altpriority_encoder_tv8   altpriority_encoder10
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder10_q));
	Adder_altpriority_encoder_te9   altpriority_encoder11
	( 
	.data(data[63:32]),
...
endmodule //Adder_altpriority_encoder_uu8
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_nh8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //Adder_altpriority_encoder_nh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_qh8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_nh8   altpriority_encoder36
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder36_q),
	.zero(wire_altpriority_encoder36_zero));
	Adder_altpriority_encoder_nh8   altpriority_encoder37
	( 
	.data(data[3:2]),
...
endmodule //Adder_altpriority_encoder_qh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_vh8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_qh8   altpriority_encoder34
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder34_q),
	.zero(wire_altpriority_encoder34_zero));
	Adder_altpriority_encoder_qh8   altpriority_encoder35
	( 
	.data(data[7:4]),
...
endmodule //Adder_altpriority_encoder_vh8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_fj8
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_vh8   altpriority_encoder32
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder32_q),
	.zero(wire_altpriority_encoder32_zero));
	Adder_altpriority_encoder_vh8   altpriority_encoder33
	( 
	.data(data[15:8]),
...
endmodule //Adder_altpriority_encoder_fj8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_hi9
	( 
	data,
	q,
	zero) ;
	...
	Adder_altpriority_encoder_fj8   altpriority_encoder30
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder30_q),
	.zero(wire_altpriority_encoder30_zero));
	Adder_altpriority_encoder_fj8   altpriority_encoder31
	( 
	.data(data[31:16]),
...
endmodule //Adder_altpriority_encoder_hi9
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_n28
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //Adder_altpriority_encoder_n28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_q28
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	Adder_altpriority_encoder_nh8   altpriority_encoder44
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder44_q),
	.zero(wire_altpriority_encoder44_zero));
	Adder_altpriority_encoder_n28   altpriority_encoder45
	( 
	.data(data[3:2]),
...
endmodule //Adder_altpriority_encoder_q28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_v28
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	Adder_altpriority_encoder_qh8   altpriority_encoder42
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder42_q),
	.zero(wire_altpriority_encoder42_zero));
	Adder_altpriority_encoder_q28   altpriority_encoder43
	( 
	.data(data[7:4]),
...
endmodule //Adder_altpriority_encoder_v28

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_f48
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	Adder_altpriority_encoder_vh8   altpriority_encoder40
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder40_q),
	.zero(wire_altpriority_encoder40_zero));
	Adder_altpriority_encoder_v28   altpriority_encoder41
	( 
	.data(data[15:8]),
...
endmodule //Adder_altpriority_encoder_f48

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_h39
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	Adder_altpriority_encoder_fj8   altpriority_encoder38
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder38_q),
	.zero(wire_altpriority_encoder38_zero));
	Adder_altpriority_encoder_f48   altpriority_encoder39
	( 
	.data(data[31:16]),
...
endmodule //Adder_altpriority_encoder_h39

//synthesis_resources = reg 6 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altpriority_encoder_ina
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	Adder_altpriority_encoder_hi9   altpriority_encoder28
	( 
	.data(data[31:0]),
	.q(wire_altpriority_encoder28_q),
	.zero(wire_altpriority_encoder28_zero));
	Adder_altpriority_encoder_h39   altpriority_encoder29
	( 
	.data(data[63:32]),
...
endmodule //Adder_altpriority_encoder_ina

//synthesis_resources = lpm_add_sub 9 lpm_compare 1 reg 1417 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Adder_altfp_add_sub_pdk
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	Adder_altbarrel_shift_ptd   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Adder_altbarrel_shift_u0g   rbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Adder_altpriority_encoder_uu8   leading_zeroes_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Adder_altpriority_encoder_ina   trailing_zeros_cnt
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //Adder_altfp_add_sub_pdk
//VALID FILE
...
module Adder (
	...
	Adder_altfp_add_sub_pdk	Adder_altfp_add_sub_pdk_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.datab (datab),

...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=17 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa nan overflow result underflow
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="VARIABLE" SHIFTTYPE="LOGICAL" WIDTH=83 WIDTHDIST=7 aclr clk_en clock data direction distance result
...
module  DoubleTo32BitFixed_altbarrel_shift_j4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //DoubleTo32BitFixed_altbarrel_shift_j4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 411 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  DoubleTo32BitFixed_altfp_convert_jtp
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [82:0]   wire_altbarrel_shift2_result;
	...
	DoubleTo32BitFixed_altbarrel_shift_j4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		const_bias_value_add_width_res_w = 11'b10000001111,
...
endmodule //DoubleTo32BitFixed_altfp_convert_jtp
//VALID FILE
...
module DoubleTo32BitFixed (
	...
	DoubleTo32BitFixed_altfp_convert_jtp	DoubleTo32BitFixed_altfp_convert_jtp_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.nan (sub_wire0),

...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=13 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=3 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  Fixed13BitToFloat_altbarrel_shift_dof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Fixed13BitToFloat_altbarrel_shift_dof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //Fixed13BitToFloat_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //Fixed13BitToFloat_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	Fixed13BitToFloat_altpriority_encoder_3v7   altpriority_encoder8
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder8_q));
	Fixed13BitToFloat_altpriority_encoder_3e8   altpriority_encoder9
	( 
	.data(data[3:2]),
...
endmodule //Fixed13BitToFloat_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	Fixed13BitToFloat_altpriority_encoder_3e8   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	Fixed13BitToFloat_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //Fixed13BitToFloat_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	Fixed13BitToFloat_altpriority_encoder_6v7   altpriority_encoder6
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder6_q));
	Fixed13BitToFloat_altpriority_encoder_6e8   altpriority_encoder7
	( 
	.data(data[7:4]),
...
endmodule //Fixed13BitToFloat_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	Fixed13BitToFloat_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	Fixed13BitToFloat_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[7:4]),
...
endmodule //Fixed13BitToFloat_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	Fixed13BitToFloat_altpriority_encoder_bv7   altpriority_encoder4
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder4_q));
	Fixed13BitToFloat_altpriority_encoder_be8   altpriority_encoder5
	( 
	.data(data[15:8]),
...
endmodule //Fixed13BitToFloat_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 143 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToFloat_altfp_convert_5jn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	Fixed13BitToFloat_altbarrel_shift_dof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Fixed13BitToFloat_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	assign
		aclr = 1'b0,
		bias_value_w = 8'b01110101,
		const_bias_value_add_width_int_w = 8'b10000000,
...
endmodule //Fixed13BitToFloat_altfp_convert_5jn
//VALID FILE
...
module Fixed13BitToFloat (
	...
	Fixed13BitToFloat_altfp_convert_5jn	Fixed13BitToFloat_altfp_convert_5jn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));

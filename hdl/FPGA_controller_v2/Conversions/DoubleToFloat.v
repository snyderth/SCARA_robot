...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
module  DoubleToFloat_altfp_convert_fmn
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //DoubleToFloat_altfp_convert_fmn
//VALID FILE
...
module DoubleToFloat (
	...
	DoubleToFloat_altfp_convert_fmn	DoubleToFloat_altfp_convert_fmn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));

...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=15 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=15 clk_en clock dataa overflow result
...
module  DoubleToInt15Bit_altbarrel_shift_oof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //DoubleToInt15Bit_altbarrel_shift_oof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 334 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  DoubleToInt15Bit_altfp_convert_qco
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	DoubleToInt15Bit_altbarrel_shift_oof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //DoubleToInt15Bit_altfp_convert_qco
//VALID FILE
...
module DoubleToInt15Bit (
	...
	DoubleToInt15Bit_altfp_convert_qco	DoubleToInt15Bit_altfp_convert_qco_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.overflow (sub_wire0),

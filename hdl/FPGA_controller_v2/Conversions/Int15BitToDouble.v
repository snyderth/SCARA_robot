...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=15 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=15 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=15 WIDTHDIST=4 aclr clk_en clock data distance result
...
module  Int15BitToDouble_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[14:0]	sbit_piper1d;
	reg	[14:0]	sbit_piper2d;
	reg	sel_pipec2r1d;
	reg	sel_pipec3r1d;
	wire  [4:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 15'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[29:15];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 15'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[59:45];
	// synopsys translate_off
	initial
		sel_pipec2r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		pad_w = {8{1'b0}},
		result = sbit_w[74:60],
		sbit_w = {sbit_piper2d, smux_w[44:30], sbit_piper1d, smux_w[14:0], data},
		sel_w = {sel_pipec3r1d, sel_pipec2r1d, distance[1:0]},
		smux_w = {((({15{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[51:45], pad_w[7:0]}) | ({15{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[59:53]})) | ({15{(~ sel_w[3])}} & sbit_w[59:45])), ((({15{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[40:30], pad_w[3:0]}) | ({15{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[44:34]})) | ({15{(~ sel_w[2])}} & sbit_w[44:30])), ((({15{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[27:15], pad_w[1:0]}) | ({15{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[29:17]})) | ({15{(~ sel_w[1])}} & sbit_w[29:15])), ((({15{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[13:0], pad_w[0]}) | ({15{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[14:1]})) | ({15{(~ sel_w[0])}} & sbit_w[14:0]))};
endmodule //Int15BitToDouble_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //Int15BitToDouble_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //Int15BitToDouble_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	Int15BitToDouble_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	Int15BitToDouble_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
endmodule //Int15BitToDouble_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	Int15BitToDouble_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	Int15BitToDouble_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //Int15BitToDouble_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	Int15BitToDouble_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	Int15BitToDouble_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
endmodule //Int15BitToDouble_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	Int15BitToDouble_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	Int15BitToDouble_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
endmodule //Int15BitToDouble_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	Int15BitToDouble_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	Int15BitToDouble_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
endmodule //Int15BitToDouble_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 221 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Int15BitToDouble_altfp_convert_6gn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [14:0]   wire_altbarrel_shift5_result;
	...
	reg	[13:0]	mag_int_a_reg;
	reg	[13:0]	mag_int_a_reg2;
	...
	reg	sign_int_a_reg4;
	reg	sign_int_a_reg5;
	wire  [13:0]   wire_add_sub1_result;
	...
	wire  [14:0]  prio_mag_int_a;
	wire  [0:0]  priority_pad_one_w;
	wire  [63:0]  result_w;
	wire  [13:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [6:0]  zero_padding_w;

	Int15BitToDouble_altbarrel_shift_fof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Int15BitToDouble_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 14'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 14'b0;
	...
	assign
		...
		const_bias_value_add_width_int_w = 11'b10000001100,
		...
		mag_int_a = (({14{(~ sign_int_a)}} & int_a) | ({14{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[51:0],
		mantissa_pre_round = {shifted_mag_int_a[13:0], {39{1'b0}}},
		mantissa_rounded = mantissa_pre_round_reg,
		max_neg_value_selector = (wire_cmpr4_alb & sign_int_a_reg2),
		max_neg_value_w = 11'b10000001101,
		minus_leading_zero = {zero_padding_w, leading_zeroes},
		prio_mag_int_a = {mag_int_a_reg, 1'b1},
		priority_pad_one_w = 1'b1,
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift5_result[13:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[14],
		zero_padding_w = {7{1'b0}};
endmodule //Int15BitToDouble_altfp_convert_6gn
//VALID FILE
...
module Int15BitToDouble (
	...
	Int15BitToDouble_altfp_convert_6gn	Int15BitToDouble_altfp_convert_6gn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL Int15BitToDouble.cmp FALSE TRUE

...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clk_en clock dataa result
...
module  FloatToDouble_altfp_convert_fmn
	( 
	clk_en,
	clock,
	dataa,
...
endmodule //FloatToDouble_altfp_convert_fmn
//VALID FILE
...
module FloatToDouble (
	...
	FloatToDouble_altfp_convert_fmn	FloatToDouble_altfp_convert_fmn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));

...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=13 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=3 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=13 WIDTHDIST=4 aclr clk_en clock data distance result
...
module  Fixed13BitToDouble_altbarrel_shift_dof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //Fixed13BitToDouble_altbarrel_shift_dof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //Fixed13BitToDouble_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //Fixed13BitToDouble_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	wire  [0:0]   wire_altpriority_encoder8_q;
	wire  [0:0]   wire_altpriority_encoder9_q;
	wire  wire_altpriority_encoder9_zero;

	Fixed13BitToDouble_altpriority_encoder_3v7   altpriority_encoder8
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder8_q));
	Fixed13BitToDouble_altpriority_encoder_3e8   altpriority_encoder9
	( 
	.data(data[3:2]),
	.q(wire_altpriority_encoder9_q),
	.zero(wire_altpriority_encoder9_zero));
	assign
		q = {(~ wire_altpriority_encoder9_zero), ((wire_altpriority_encoder9_zero & wire_altpriority_encoder8_q) | ((~ wire_altpriority_encoder9_zero) & wire_altpriority_encoder9_q))};
endmodule //Fixed13BitToDouble_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	Fixed13BitToDouble_altpriority_encoder_3e8   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	Fixed13BitToDouble_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
	...
	assign
		...
		zero = (wire_altpriority_encoder10_zero & wire_altpriority_encoder11_zero);
endmodule //Fixed13BitToDouble_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	wire  [1:0]   wire_altpriority_encoder6_q;
	wire  [1:0]   wire_altpriority_encoder7_q;
	wire  wire_altpriority_encoder7_zero;

	Fixed13BitToDouble_altpriority_encoder_6v7   altpriority_encoder6
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder6_q));
	Fixed13BitToDouble_altpriority_encoder_6e8   altpriority_encoder7
	( 
	.data(data[7:4]),
	.q(wire_altpriority_encoder7_q),
	.zero(wire_altpriority_encoder7_zero));
	assign
		q = {(~ wire_altpriority_encoder7_zero), (({2{wire_altpriority_encoder7_zero}} & wire_altpriority_encoder6_q) | ({2{(~ wire_altpriority_encoder7_zero)}} & wire_altpriority_encoder7_q))};
endmodule //Fixed13BitToDouble_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	Fixed13BitToDouble_altpriority_encoder_6e8   altpriority_encoder12
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder12_q),
	.zero(wire_altpriority_encoder12_zero));
	Fixed13BitToDouble_altpriority_encoder_6e8   altpriority_encoder13
	( 
	.data(data[7:4]),
...
endmodule //Fixed13BitToDouble_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altpriority_encoder_rb6
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	wire  [2:0]   wire_altpriority_encoder4_q;
	wire  [2:0]   wire_altpriority_encoder5_q;
	wire  wire_altpriority_encoder5_zero;

	Fixed13BitToDouble_altpriority_encoder_bv7   altpriority_encoder4
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder4_q));
	Fixed13BitToDouble_altpriority_encoder_be8   altpriority_encoder5
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder5_q),
	.zero(wire_altpriority_encoder5_zero));
	assign
		q = {(~ wire_altpriority_encoder5_zero), (({3{wire_altpriority_encoder5_zero}} & wire_altpriority_encoder4_q) | ({3{(~ wire_altpriority_encoder5_zero)}} & wire_altpriority_encoder5_q))};
endmodule //Fixed13BitToDouble_altpriority_encoder_rb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 213 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  Fixed13BitToDouble_altfp_convert_mkn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [12:0]   wire_altbarrel_shift3_result;
	...
	Fixed13BitToDouble_altbarrel_shift_dof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	Fixed13BitToDouble_altpriority_encoder_rb6   altpriority_encoder2
	( 
	...
	defparam
		...
		below_bias_value.lpm_width = 11,
		below_bias_value.lpm_type = "lpm_compare";
	assign
		aclr = 1'b0,
		bias_value_w = 11'b01111110101,
		const_bias_value_add_width_int_w = 11'b10000000000,
		...
		max_neg_value_w = 11'b10000000001,
		minus_leading_zero = {zero_padding_w, leading_zeroes},
		prio_mag_int_a = {mag_int_a_reg, 1'b1},
		priority_pad_one_w = {3{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift3_result[11:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[12],
		zero_padding_w = {7{1'b0}};
endmodule //Fixed13BitToDouble_altfp_convert_mkn
//VALID FILE
...
module Fixed13BitToDouble (
	...
	Fixed13BitToDouble_altfp_convert_mkn	Fixed13BitToDouble_altfp_convert_mkn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));

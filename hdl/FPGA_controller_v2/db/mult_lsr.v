//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="AUTO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=53 LPM_WIDTHB=54 LPM_WIDTHP=107 clken clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [106:0]  result_output_reg;
	reg  [106:0]  result_extra0_reg;
	wire [52:0]    dataa_wire;
	wire [53:0]    datab_wire;
	wire [106:0]    result_wire;
	...
	always @(posedge clock)
		if (clken == 1'b1)
			result_extra0_reg <= result_wire[106:0];

//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=16 LPM_WIDTHB=19 LPM_WIDTHP=35 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_je01
	...
	wire	[20:0]	wire_sum_adder1aa_7result_int;
	...
	wire  w449w;
	wire  [35:0]  w812w;
	wire  [303:0]  w_decoder_node9w;
	wire  [15:0]  w_le_datab_node8w;
	wire  [167:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7result_int[20:1];
	assign
	...
	assign
		wire_sft13a_in = {w449w, {w_sum_node10w[103], {(~ w_sum_node10w[83]), {w435w, {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106:105]}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w449w, {w449w, {w449w, {w_sum_node10w[101], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30:29]}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w449w, {w449w, {w449w, {w449w, {(~ w_sum_node10w[62]), {w435w, {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {2{w449w}}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w449w, {w_sum_node10w[61], {(~ w_sum_node10w[41]), {w435w, {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[148:147]}}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w449w, {w449w, {w449w, {w_sum_node10w[40], {(~ w_sum_node10w[20]), {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w449w, {w449w, {w449w, {w449w, {w435w, {w449w, {w449w, {w449w, {w449w, {2{w449w}}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft9a_in = {w449w, {w449w, {w449w, {w_sum_node10w[162], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45:44]}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[18:0]},
		datab_node = {dataa[15:0]},
		final_result_node = {w812w[34:0]},
		result = {final_result_node[34:0]},
		w435w = 1'b1,
		w449w = 1'b0,
		w812w = {wire_sft6a_out[33:32], wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[18:0]} & {19{w_le_datab_node8w[15]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[14]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[13]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[12]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[11]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[10]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[9]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[8]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[7]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[6]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[5]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[4]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[3]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[2]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[1]}}), ({dataa_node[18:0]} & {19{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[15:0]},
		w_sum_node10w = {wire_sum_adder1aa_7result[19:0], w_decoder_node9w[266], wire_sum_adder1aa_6result[19:0], w_decoder_node9w[228], wire_sum_adder1aa_5result[19:0], w_decoder_node9w[190], wire_sum_adder1aa_4result[19:0], w_decoder_node9w[152], wire_sum_adder1aa_3result[19:0], w_decoder_node9w[114], wire_sum_adder1aa_2result[19:0], w_decoder_node9w[76], wire_sum_adder1aa_1result[19:0], w_decoder_node9w[38], wire_sum_adder1aa_0result[19:0], w_decoder_node9w[0]};
endmodule //mult_je01
//VALID FILE

...
module  mult_sj01
	...
	wire  w119w;
	wire  [16:0]  w181w;
	wire  [54:0]  w_decoder_node9w;
	wire  [4:0]  w_le_datab_node8w;
	wire  [10:0]  w_lone_sum_node11w;
	wire  [25:0]  w_sum_node10w;
	...
	assign
		wire_sft3a_in = {w119w, {w119w, {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w119w, {w119w, {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14:13]}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w119w, {w119w, {w119w, {w119w, {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w119w}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		...
		final_result_node = {w181w[15:0]},
		result = {final_result_node[15:0]},
		w119w = 1'b0,
		w181w = {wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[10:0]} & {11{w_le_datab_node8w[4]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[3]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[2]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[1]}}), ({dataa_node[10:0]} & {11{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[4:0]},
		w_lone_sum_node11w = {w_decoder_node9w[54:44]},
		w_sum_node10w = {wire_sum_adder1aa_1result[11:0], w_decoder_node9w[22], wire_sum_adder1aa_0result[11:0], w_decoder_node9w[0]};
endmodule //mult_sj01
//VALID FILE

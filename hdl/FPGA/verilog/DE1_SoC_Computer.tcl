...
# File: DE1_SoC_Computer.tcl
# Generated on: Sun Feb 23 19:00:05 2020
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "DE1_SoC_Computer"]} {
		puts "Project DE1_SoC_Computer is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists DE1_SoC_Computer]} {
		project_open -revision DE1_SoC_Computer DE1_SoC_Computer
	} else {
		project_new -revision DE1_SoC_Computer DE1_SoC_Computer
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/SineTh2.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/K1.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/ForwardKinematics.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/CosineTh2.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/CalculateSteps.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/CalculateAngles.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Functions/Arctan2.sv
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/Int15BitToDouble.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/FloatToDouble.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/Fixed13BitToFloat.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/Fixed13BitToDouble.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/DoubleToInt15Bit.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/DoubleToInt9Bit.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/DoubleToFloat.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/DoubleToFixed42Bit.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Conversions/DoubleTo32BitFixed.v
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/BasicBlocks/Sync/Sync.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/BasicBlocks/Counter/Counter.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/BasicBlocks/ClockTimer/ClockTimer.sv
	set_global_assignment -name QSYS_FILE ../../FPGA_controller_v2/Atan2.qsys
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Atan2/synthesis/Atan2.v
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Arithmetic/SqRoot/SquareRoot.sv
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/SqRoot/SqRoot.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/SinCos/Cosine.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/SinCos/Sine.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/MultiplierFP/MultiplierFP.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/Inverter/Inverter.v
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/FloatAdder/FloatAdder.v
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Arithmetic/DoubleMultiplier/DoubleMultiply.sv
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/DoubleDivider/DoubleDiv.v
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/Arithmetic/DoubleAdder/DoubleAdder.sv
	set_global_assignment -name VERILOG_FILE ../../FPGA_controller_v2/Arithmetic/Adder/Adder.v
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/BasicBlocks/SRLatch/SRLatch.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../StepperMotor/StepperFPGA/stepper_motor/stp_counter.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../FPGA_controller_v2/ScaraController.sv
	set_global_assignment -name SYSTEMVERILOG_FILE ../../StepperMotor/StepperFPGA/stepper_motor/stepper_motor.sv
	set_global_assignment -name SDC_FILE DE1_SoC_Computer.out.sdc
	set_global_assignment -name QIP_FILE Computer_System/synthesis/Computer_System.qip
	set_global_assignment -name VERILOG_FILE hex_decoder.v
	set_global_assignment -name SYSTEMVERILOG_FILE DE1_SoC_Computer.sv
	set_global_assignment -name SYSTEMVERILOG_FILE State_Interface.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Fake_Controller.sv

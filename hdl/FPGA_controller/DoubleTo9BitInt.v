...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=9 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=9 clk_en clock dataa nan overflow result underflow
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=60 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  DoubleTo9BitInt_altbarrel_shift_hof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //DoubleTo9BitInt_altbarrel_shift_hof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 310 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  DoubleTo9BitInt_altfp_convert_jkp
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	wire  [59:0]   wire_altbarrel_shift6_result;
	...
	DoubleTo9BitInt_altbarrel_shift_hof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		const_bias_value_add_width_res_w = 11'b10000000111,
		...
		lbarrel_shift_w = lbarrel_shift_result_w[59:52],
...
endmodule //DoubleTo9BitInt_altfp_convert_jkp
//VALID FILE
...
module DoubleTo9BitInt (
	...
	DoubleTo9BitInt_altfp_convert_jkp	DoubleTo9BitInt_altfp_convert_jkp_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.nan (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL DoubleTo9BitInt.cmp FALSE TRUE
